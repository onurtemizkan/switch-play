...
import net.sourceforge.htmlunit.corejs.classfile.*;
...
public final class JavaAdapter implements IdFunctionCall {
    ...
    static Object js_createAdapter(Context cx, Scriptable scope, Object[] args) {
        ...
        for (classCount = 0; classCount < N - 1; classCount++) {
            ...
            if (!(arg instanceof NativeJavaClass)) {
                throw ScriptRuntime
                        .typeError2("msg.not.java.class.arg",
        ...
        try {
            if (argsCount > 0) {
                ...
                adapter = adapterClass.getConstructor(ctorParms).newInstance(
                        ctorArgs);
            }
    ...
    public static byte[] createAdapterCode(ObjToIntMap functionNames,
        ...
        cfw.addField(
                "factory",
                "Lnet/sourceforge/htmlunit/corejs/javascript/ContextFactory;",
    ...
    private static void generateCtor(ClassFileWriter cfw, String adapterName,
        ...
        if (parameters.length == 0) {
            cfw.startMethod(
                    "<init>",
                    "(Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
                            + "Lnet/sourceforge/htmlunit/corejs/javascript/ContextFactory;)V",
    ...
    private static void generateEmptyCtor(ClassFileWriter cfw,
        ...
        cfw.addInvoke(
                ...
                "net/sourceforge/htmlunit/corejs/javascript/JavaAdapter",
                "runScript",
                "(Lnet/sourceforge/htmlunit/corejs/javascript/Script;"
                        + ")Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;");
        ...
        if (retType == Void.TYPE) {
            ...
            if (callConvertResult) {
                ...
                cfw.addInvoke(
                        ByteCode.INVOKESTATIC,
                        "net/sourceforge/htmlunit/corejs/javascript/JavaAdapter",
                        "convertResult", "(Ljava/lang/Object;"
    ...
    private static void generateMethod(ClassFileWriter cfw, String genName,
        ...
        cfw.addInvoke(
                ...
                "(Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
                        + "Ljava/lang/String;"
                        + ")Lnet/sourceforge/htmlunit/corejs/javascript/Function;");
