...
import net.sourceforge.htmlunit.corejs.javascript.ScriptRuntime.NoSuchMethodShim;
import net.sourceforge.htmlunit.corejs.javascript.debug.DebugFrame;

import static net.sourceforge.htmlunit.corejs.javascript.UniqueTag.DOUBLE_MARK;
...
public final class Interpreter extends Icode implements Evaluator {
                    ...
                    jumplessRun: {
                        ...
                        case Icode_VAR_INC_DEC: {
                            stackTop = doVarIncDec(cx, frame, stack, sDbl,
                                    stackTop, vars, varDbls, indexReg);
                            continue Loop;
                        }
                        case Icode_ZERO:
                            ++stackTop;
    ...
    private static void enterFrame(Context cx, CallFrame frame, Object[] args,
        ...
        if (frame.parentFrame != null
                && !frame.parentFrame.fnOrScript.isScript()) {
        ...
        if (frame.scope instanceof NativeCall) {
            Object arguments = ScriptableObject.getProperty(frame.scope,
                    "arguments");
